...
func (app *Application) RemoveItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.IndentedJSON(200, "success removed from cart")
	}
}
...
func GetItemFromCart() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			log.Println(err)
			c.IndentedJSON(500, "user id not found")
		}

		filter_match := bson.D{
			{
				Key:   "$match",
				Value: bson.D{primitive.E{Key: "_id", Value: usert_id}},
			},
		}
		unwind := bson.D{
			{
				Key:   "$unwind",
				Value: bson.D{primitive.E{Key: "path", Value: "$usercart"}},
			},
		}
		grouping := bson.D{
			{
...
func (app *Application) InstantBuy() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if ProductQueryID == "" {
			log.Println("Product_ID is empty")
